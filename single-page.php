...
<div class="flex items-center h-[350px] justify-center flex-wrap w-full">
...
<div class="container mx-auto">
    ...
    <div class="block w-full flex items-stretch lg:flex-nowrap flex-wrap">
        ...
        <div class="w-full flex flex-col place-content-between  ">
            ...
            <div class="lg:px-5 py-5">
                ...
                <h2 class="mb-5 font-bold uppercase">Об ассоциации</h2>
            </div>
...
<div class="relative z-40 py-20">
    <div class="text-center justify-center flex items-center w-full flex-wrap">
        ...
        <div
            class="mb-10 flex items-center justify-center border-b border-white border-opacity-20 w-full py-10">
